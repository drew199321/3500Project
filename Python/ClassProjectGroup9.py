...
while(exit == False):
    ...
    print("1: In what month were there more accidents reported?")
    print("2: What is the state that had the most accidents in 2020?")
    print("3: What is the state that had the most accidents of severity 2 in 2021?")
    print("4. What severity is the most common in Virginia?")
    print("5. What are the 5 cities that had the most accidents in 2019 in California?")
    print("6. What was the average humidity and average temperature of all accidents of severity 4 that occurred in 2021?")
    print("7. What are the 3 most common weather conditions (weather_conditions) when accidents occurred?")
    ...
    print("10. What was the longest accident (in hours) recorded in Florida in the Spring (March, April, and May) of 2022? **CURRENTLY BROKEN**")
    action = input()
